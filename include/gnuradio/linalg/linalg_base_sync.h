...
class LINALG_API linalg_base_sync : virtual public linalg_base<Scalar>,
                                    public gr::sync_block {
public:
  /*!
   * \brief Constructor for linalg_base_sync
   ...
   */
  linalg_base_sync(const std::string &name,
                   const types::vector_shapes &shape_inputs,
                   const types::vector_shapes &shape_outputs);

  /*!
   * \brief Constructor for linalg_base_sync with input/output names
   * \param name Name of the block
   * \param shape_inputs Vector of input shapes
...
public:
  /*!
   * \brief Destructor for linalg_base_sync
   */
  virtual ~linalg_base_sync() = default;

  /*!
   * \brief Work function for linalg_base_sync
